    ...
    if (this.functionCode === constants.TNS_FUNC_AUTH_PHASE_ONE) {
      ...
      if (this.changePassword) {
        ...
        if (this.externalAuth) {
          ...
          numPairs += 2;
          if (this.verifierType === constants.TNS_VERIFIER_TYPE_10G &&
              this.conn._protocol.caps.protocolVersion ===
              constants.TNS_VERSION_11_2) {
            verifier10G = true;
          } else if (this.verifierType === constants.TNS_VERIFIER_TYPE_11G_1 ||
          ...
          if (verifier10G) {
            ED.updateVerifierData10G(this.sessionData, this.username,
              this.password, this.newPassword, this);
          } else {
            ED.updateVerifierData(this.sessionData, this.password,
              this.newPassword, verifier11G, this);
          }
